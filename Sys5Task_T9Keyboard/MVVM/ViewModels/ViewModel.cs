...
using Sys5Task_T9Keyboard.MVVM.Commands;
using Sys5Task_T9Keyboard.MVVM.Views;

namespace Sys5Task_T9Keyboard.MVVM.ViewModels
{
    public class ViewModel
    {
        ...
        public T9Keyboard T9Keyboard { get; set; }
        ...
        public ViewModel()
        {
            ...
            _readyWords.Add("ITEMS1");
            _readyWords.Add("ITEMS2");
            _readyWords.Add("ITEMS3");
            _readyWords.Add("ITEMS4");
            _readyWords.Add("ITEMS5");
            _readyWords.Add("ITEMS6");
            _readyWords.Add("ITEMS7");
            _readyWords.Add("ITEMS8");
            _readyWords.Add("ITEMS9");
            _readyWords.Add("ITEMS10");
